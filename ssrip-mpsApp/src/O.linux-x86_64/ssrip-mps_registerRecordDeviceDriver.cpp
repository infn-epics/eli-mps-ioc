...
/* Generated from ../O.Common/ssrip-mps.dbd */
...
/* ssrip_mps_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: ssrip_mps_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(ssrip_mps_registerRecordDeviceDriver(*iocshPpdbbase));
}
