...
drvModbusAsynConfigure("$(MPS_ASYNPORT)_BYPASS_VAC_COR_SP", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 16, 200, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
drvModbusAsynConfigure("$(MPS_ASYNPORT)_BYPASS_VAC_RUF_SP", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 16, 202, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
drvModbusAsynConfigure("$(MPS_ASYNPORT)_BYPASS_LLRF_SP", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 16, 210, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
drvModbusAsynConfigure("$(MPS_ASYNPORT)_BYPASS_MOD_SP", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 16, 220, 2, 6, $(MPS_POLLING), $(MPS_MSGS))

drvModbusAsynConfigure("$(MPS_ASYNPORT)_VAC_COR_RB", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 3, 100, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
drvModbusAsynConfigure("$(MPS_ASYNPORT)_VAC_RUF_RB", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 3, 102, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
drvModbusAsynConfigure("$(MPS_ASYNPORT)_LLRF_RB", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 3, 110, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
drvModbusAsynConfigure("$(MPS_ASYNPORT)_MOD_RB", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 3, 120, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
