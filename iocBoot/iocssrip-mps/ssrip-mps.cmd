...
drvModbusAsynConfigure("$(MPS_ASYNPORT)_BYPASS_VAC_COR_SP", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 6, 200, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
drvModbusAsynConfigure("$(MPS_ASYNPORT)_BYPASS_VAC_RUF_SP", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 6, 202, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
drvModbusAsynConfigure("$(MPS_ASYNPORT)_BYPASS_LLRF_SP", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 6, 210, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
drvModbusAsynConfigure("$(MPS_ASYNPORT)_BYPASS_MOD_SP", "$(MPS_ASYNPORT)", $(MPS_SLAVE_ADDR), 6, 220, 2, 6, $(MPS_POLLING), $(MPS_MSGS))
